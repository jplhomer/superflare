...
export function ThemeSelector(props) {
  ...
  return (
    ...
    >
      ...
      >
        <LightIcon className="hidden h-4 w-4 fill-rose-400 [[data-theme=light]_&]:block" />
        <DarkIcon className="hidden h-4 w-4 fill-rose-400 [[data-theme=dark]_&]:block" />
