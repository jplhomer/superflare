/**
 * This is copied from the Miniflare repo only because it hasn't been released yet:
 * @see https://github.com/cloudflare/miniflare/blob/master/packages/d1/src/d1js.ts
 * TODO: Remove this once it's been released
 */
